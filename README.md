...
> **v0.6.x-dev（开发预览版）** — **本项目尚未正式发布。** 当前代码仅供开发者本地启动、测试和继续开发使用。v0.1–v0.4 为 demo 探索版（已封存），v0.5 起为开发预览版，v1.0.x 为第一个正式发布版。
>
...
> **注意：以下指引适用于尚未正式发布的开发预览版（v0.6.x-dev）。** 项目结构和启动方式在正式发布前可能随时调整。

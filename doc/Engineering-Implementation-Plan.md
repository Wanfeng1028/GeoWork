...
P0 (ReAct 循环)  ████████████████████████████████████████
                 │
E0 (基础设施)    ├── lint/tsconfig/CI ──┤
                 │                       │
                 │         P1 (审批/WS)  │  ████████████████████████
                 │                       │           │
E1 (测试)        │                       ├── MSW/集成测试/Playwright ──┤
                 │                       │                            │
                 │                       │              P2 (Browser)  │  ████████████████
E2 (可观测性)    │                       │                            ├── Sentry/FF/监控 ──┤
                 │                       │                            │                    │
                 │                       │                            │         P3 (...)   │  ████...
```
...
| 节点 | 条件 | 说明 |
|---|---|---|
| E0 完成 | P0 结束前 | CI pipeline + lint + Prettier + tsconfig strict 就位 |
| E1 完成 | P0→P1 间隙 | 测试框架就位，P1 的审批流/WS 有集成测试覆盖 |
| E2 完成 | P1 期间并行 | 错误上报 + Feature Flags 就位 |

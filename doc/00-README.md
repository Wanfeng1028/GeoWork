...
# 在正式开工写代码之前，你需要做的事情是检查/配置：

### 决策原则：P0 开工前必须就绪的做，P0 期间顺手做的做，其余全部推迟到触发条件满足时

我把 20 个 TODO 按"什么时候做"分成四档，每个给出明确决策和理由。
...
**总计约 2 小时。** 做完这些，P0 的代码质量基础设施就绑定了。

------

## **对文档本身的建议**

你现在的 TODO 散落在 12 份文档里，没有统一的追踪视图。建议在 `doc/00-README.md` 底部加一个 **"全局 TODO 看板"** 章节，把上面这张四档表放进去。每次 P 阶段结束时更新一次状态（Done / In Progress / Deferred）。这样你不需要翻 12 份文档就知道"还有什么没做"。

做完第一档的 2 小时配置工作后，就可以正式开始 P0 了。
